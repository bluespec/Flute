...
module mkDM_GPR_Tap(CLK,
  ...
  output [77 : 0] client_request_get;
  ...
  wire [77 : 0] f_req_in$D_IN, f_req_in$D_OUT;
  wire f_req_in$CLR,
       f_req_in$DEQ,
       f_req_in$EMPTY_N,
       f_req_in$ENQ,
  ...
  wire [77 : 0] f_req_out$D_IN, f_req_out$D_OUT;
  wire f_req_out$CLR,
       f_req_out$DEQ,
       f_req_out$EMPTY_N,
       f_req_out$ENQ,
  ...
  // submodule f_req_in
  FIFO2 #(.width(32'd78), .guarded(32'd1)) f_req_in(.RST(RST_N),
						    .CLK(CLK),
						    .D_IN(f_req_in$D_IN),
						    .ENQ(f_req_in$ENQ),
						    .DEQ(f_req_in$DEQ),
  ...
  // submodule f_req_out
  FIFO2 #(.width(32'd78), .guarded(32'd1)) f_req_out(.RST(RST_N),
						     .CLK(CLK),
						     .D_IN(f_req_out$D_IN),
						     .ENQ(f_req_out$ENQ),
						     .DEQ(f_req_out$DEQ),
  ...
  assign CAN_FIRE_RL_request =
	     ...
	     (!f_req_in$D_OUT[77] || f_trace_data$FULL_N) ;
  ...
  assign f_trace_data$ENQ = WILL_FIRE_RL_request && f_req_in$D_OUT[77] ;
