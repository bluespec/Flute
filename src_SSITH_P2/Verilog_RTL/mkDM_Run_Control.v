...
module mkDM_Run_Control(CLK,
  ...
  wire write_dm_addr_EQ_0x10_6_AND_write_dm_word_BIT__ETC___d79;
  ...
  assign MUX_rg_dmstatus_allresumeack$write_1__SEL_3 =
	     EN_write &&
	     write_dm_addr_EQ_0x10_6_AND_write_dm_word_BIT__ETC___d79 ;
  ...
  assign virt_rg_dmstatus__h543 =
	     { 14'b0,
	       ...
	       !rg_hart0_running,
	       8'd130 } ;
  assign write_dm_addr_EQ_0x10_6_AND_write_dm_word_BIT__ETC___d79 =
