...
//
// On Tue Oct  2 14:56:15 EDT 2018
//
//
// Ports:
// Name                         I/O  size props
...
module mkNear_Mem(CLK,
  ...
  reg [31 : 0] v__h1060, v__h1066, v__h1211, v__h1217;
  ...
  begin
    ...
    v__h1060 = v__h1066 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset && NOT_cfg_verbosity_read_ULE_1___d9)
	$display("%0d: Near_Mem.rl_reset", v__h1060);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h1211 = v__h1217 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_complete && NOT_cfg_verbosity_read_ULE_1___d9)
	$display("%0d: Near_Mem.rl_reset_complete", v__h1211);
  end
  // synopsys translate_on
