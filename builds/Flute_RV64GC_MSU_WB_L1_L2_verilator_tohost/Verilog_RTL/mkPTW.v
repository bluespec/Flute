...
module mkPTW(CLK,
  ...
  FIFO2 #(.width(32'd129), .guarded(32'd1)) f_dmem_imem_reqs(.RST(RST_N),
							     .CLK(CLK),
  ...
  FIFO2 #(.width(32'd128), .guarded(32'd1)) f_dmem_reqs(.RST(RST_N),
							.CLK(CLK),
  ...
  FIFO2 #(.width(32'd132), .guarded(32'd1)) f_dmem_rsps(.RST(RST_N),
							.CLK(CLK),
  ...
  FIFO2 #(.width(32'd128), .guarded(32'd1)) f_imem_reqs(.RST(RST_N),
							.CLK(CLK),
  ...
  FIFO2 #(.width(32'd132), .guarded(32'd1)) f_imem_rsps(.RST(RST_N),
							.CLK(CLK),
  ...
  FIFO2 #(.width(32'd64), .guarded(32'd1)) f_mem_reqs(.RST(RST_N),
						      .CLK(CLK),
  ...
  FIFO2 #(.width(32'd65), .guarded(32'd1)) f_mem_rsps(.RST(RST_N),
						      .CLK(CLK),
  ...
  always@(MUX_f_mem_reqs$enq_1__SEL_1 or
	  lev_1_pte_pa__h1833 or
	  MUX_f_mem_reqs$enq_1__SEL_2 or
	  lev_0_pte_pa__h2882 or
	  WILL_FIRE_RL_rl_ptw_start or lev_2_pte_pa__h1365)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_f_mem_reqs$enq_1__SEL_1: rg_pte_pa$D_IN = lev_1_pte_pa__h1833;
      MUX_f_mem_reqs$enq_1__SEL_2: rg_pte_pa$D_IN = lev_0_pte_pa__h2882;
      WILL_FIRE_RL_rl_ptw_start: rg_pte_pa$D_IN = lev_2_pte_pa__h1365;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_f_mem_reqs$enq_1__SEL_1: f_mem_reqs$D_IN = lev_1_pte_pa__h1833;
      MUX_f_mem_reqs$enq_1__SEL_2: f_mem_reqs$D_IN = lev_0_pte_pa__h2882;
      WILL_FIRE_RL_rl_ptw_start: f_mem_reqs$D_IN = lev_2_pte_pa__h1365;
  ...
  assign f_mem_rsps_i_notEmpty__0_AND_IF_f_mem_rsps_fir_ETC___d60 =
		...
		IF_f_dmem_imem_reqs_i_notEmpty__0_AND_f_dmem_i_ETC___d53) ;
  assign lev_0_pte_pa__h2882 = lev_1_PTN_pa__h1831 + vpn_0_pa__h2881 ;
  assign lev_1_PTN_pa__h1831 = { 8'd0, x__h2092 } ;
  assign lev_1_pte_pa__h1833 = lev_1_PTN_pa__h1831 + vpn_1_pa__h1832 ;
  assign lev_2_pte_pa__h1365 = satp_pa__h1040 + vpn_2_pa__h1364 ;
  assign satp_pa__h1040 = { 8'd0, x__h1286 } ;
  assign vpn_0_pa__h2881 = { 52'd0, f_dmem_imem_reqs$D_OUT[84:76], 3'd0 } ;
  assign vpn_1_pa__h1832 = { 52'd0, f_dmem_imem_reqs$D_OUT[93:85], 3'd0 } ;
  assign vpn_2_pa__h1364 = { 52'd0, f_dmem_imem_reqs$D_OUT[102:94], 3'd0 } ;
  assign x__h1286 = { f_dmem_imem_reqs$D_OUT[43:0], 12'b0 } ;
  assign x__h2092 = { f_mem_rsps$D_OUT[53:10], 12'b0 } ;
  ...
  begin
    ...
    v__h1141 = v__h1147 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_ptw_start && verbosity != 3'd0)
	$display("%0d: %m.rl_ptw_start:", v__h1141);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_ptw_start && verbosity != 3'd0 &&
	  f_dmem_imem_reqs$D_OUT[128])
	$write("    for D_Mem:");
    ...
    v__h1534 = v__h1540 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_ptw_level_2 && verbosity != 3'd0)
	$display("%0d: %m.rl_ptw_level_2:", v__h1534);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_ptw_level_2 && verbosity != 3'd0)
    ...
    v__h2602 = v__h2608 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_ptw_level_1 && verbosity != 3'd0)
	$display("%0d: %m.rl_ptw_level_1:", v__h2602);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_ptw_level_1 && verbosity != 3'd0)
	$display("    satp_pa %0h  va %0h  pte_pa %0h",
		 satp_pa__h1040,
    ...
    v__h3604 = v__h3610 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_ptw_level_0 && verbosity != 3'd0)
	$display("%0d: %m.rl_ptw_level_0:", v__h3604);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_ptw_level_0 && verbosity != 3'd0)
	$display("    satp_pa %0h  va %0h  pte_pa %0h",
		 satp_pa__h1040,
