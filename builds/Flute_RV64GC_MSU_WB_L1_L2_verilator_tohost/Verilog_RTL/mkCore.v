...
module mkCore(CLK,
  ...
  begin
    ...
    v__h4267 = v__h4273 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_from_soc_start)
	$display("%0d: Core.rl_cpu_hart0_reset_from_soc_start", v__h4267);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h4508 = v__h4514 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_complete)
	$display("%0d: Core.rl_cpu_hart0_reset_complete", v__h4508);
  end
  // synopsys translate_on
endmodule  // mkCore
