...
module mkMem_Controller(CLK,
  ...
  reg [63 : 0] rdata__h5059, word64_old__h5853;
  wire [63 : 0] exit_value__h7851,
		f_reqs_rv_BITS_164_TO_101_MINUS_rg_addr_base__q1,
		mask__h5858,
		req_raw_mem_addr__h3305,
		updated_word64__h5859,
		x__h6232,
		y__h6233,
		y__h6234;
  ...
  assign MUX_slave_xactor_f_rd_data$enq_1__VAL_1 =
	     { f_reqs_rv[180:165], rdata__h5059, 3'd1 } ;
  ...
  assign exit_value__h7851 = { 1'd0, f_reqs_rv[63:1] } ;
  ...
  assign n__h5058 = { 3'd0, f_reqs_rv[105:104] } ;
  assign req_raw_mem_addr__h3305 =
	     { 5'd0,
  ...
  assign rg_cached_raw_mem_addr_0_EQ_0_CONCAT_f_reqs_rv_ETC___d134 =
	     rg_cached_raw_mem_addr == req_raw_mem_addr__h3305 ;
  ...
  assign updated_word64__h5859 = x__h6232 | y__h6233 ;
  assign x__h6232 = word64_old__h5853 & y__h6234 ;
  assign y__h6233 = f_reqs_rv[63:0] & mask__h5858 ;
  assign y__h6234 =
	     { ~SEXT_f_reqs_rv_port0__read__2_BIT_71_89___d190,
	       ~SEXT_f_reqs_rv_port0__read__2_BIT_70_92___d193,
	       ~SEXT_f_reqs_rv_port0__read__2_BIT_69_96___d197,
  ...
  begin
    case (f_reqs_rv[105:104])
      2'd0: word64_old__h5853 = rg_cached_raw_mem_word[63:0];
      2'd1: word64_old__h5853 = rg_cached_raw_mem_word[127:64];
      2'd2: word64_old__h5853 = rg_cached_raw_mem_word[191:128];
      2'd3: word64_old__h5853 = rg_cached_raw_mem_word[255:192];
    endcase
  end
  always@(n__h5058 or rg_cached_raw_mem_word)
  begin
    case (n__h5058)
      5'd0: rdata__h5059 = rg_cached_raw_mem_word[63:0];
      5'd1: rdata__h5059 = rg_cached_raw_mem_word[127:64];
      5'd2: rdata__h5059 = rg_cached_raw_mem_word[191:128];
      5'd3: rdata__h5059 = rg_cached_raw_mem_word[255:192];
      default: rdata__h5059 = 64'hAAAAAAAAAAAAAAAA /* unspecified value */ ;
    endcase
  end
  ...
  begin
    ...
    v__h5410 = v__h5416 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req && NOT_cfg_verbosity_read_ULE_1___d5)
	$display("%0d: Mem_Controller.rl_process_rd_req: ", v__h5410);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req && NOT_cfg_verbosity_read_ULE_1___d5)
	$write("        ");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h7607 = v__h7613 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req && NOT_cfg_verbosity_read_ULE_1___d5)
	$display("%0d: Mem_Controller.rl_process_wr_req: ", v__h7607);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req && NOT_cfg_verbosity_read_ULE_1___d5)
	$write("        ");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  rg_watch_tohost_36_AND_f_reqs_rv_port0__read___ETC___d242 &&
	  f_reqs_rv[63:1] != 63'd0)
	$display("FAIL %0d", exit_value__h7851);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h8320 = v__h8326 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_invalid_rd_address)
	$write("%0d: ERROR: Mem_Controller:", v__h8320);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_invalid_rd_address &&
	  NOT_f_reqs_rv_port0__read__2_BITS_92_TO_90_6_E_ETC___d278)
    ...
    v__h9104 = v__h9110 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_invalid_wr_address)
	$write("%0d: ERROR: Mem_Controller:", v__h9104);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_invalid_wr_address &&
	  NOT_f_reqs_rv_port0__read__2_BITS_92_TO_90_6_E_ETC___d278)
    ...
    v__h2846 = v__h2852 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_rd_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$display("%0d: Mem_Controller.rl_merge_rd_req", v__h2846);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_rd_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$write("        ");
    ...
    v__h3180 = v__h3186 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_wr_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$display("%0d: Mem_Controller.rl_merge_wr_req", v__h3180);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_wr_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$write("        ");
