...
//
// On Fri Jan 11 23:39:17 EST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkTop_HW_Side(CLK,
  ...
  // submodule soc_top
  assign soc_top$put_from_console_put = v__h735 ;
  ...
  assign soc_top$set_watch_tohost_tohost_addr = v__h543 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_step0)
	begin
	  v__h543 = $imported_c_get_symbol_val("tohost");
	  #0;
	end
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_step0)
	...
	begin
	  v__h735 = $imported_c_trygetchar(8'hAA);
	  #0;
	end
  end
  // synopsys translate_on
