...
module mkFPU(CLK,
  ...
  reg [51 : 0] CASE_fpu_div_fState_S4D_OUT_BITS_1_TO_0_0b0_f_ETC__q1,
	       ...
	       CASE_guard51238_0b0_theResult___snd59174_BITS__ETC__q79,
	       CASE_guard51238_0b0_theResult___snd59174_BITS__ETC__q80,
  ...
  reg CASE_fpu_div_fOperands_S0D_OUT_BITS_2_TO_0_0__ETC__q9,
      ...
      CASE_guard32950_0b0_iFifoD_OUT_BIT_38_0b1_iFi_ETC__q81,
      ...
      CASE_guard87260_0b0_NOT_resWirewget_BIT_68_0b_ETC__q150,
      ...
      CASE_guard96096_0b0_resWirewget_BIT_68_0b1_re_ETC__q149,
      ...
      CASE_iFifoD_OUT_BITS_6_TO_4_0_CASE_guard32950_ETC__q82,
  ...
  always@(iFifo$D_OUT or
	  CASE_guard51238_0b0_theResult___snd59174_BITS__ETC__q79 or
	  CASE_guard51238_0b0_theResult___snd59174_BITS__ETC__q80 or
  ...
  always@(iFifo$D_OUT or
	  CASE_guard32950_0b0_iFifoD_OUT_BIT_38_0b1_iFi_ETC__q81 or
	  guard__h232950)
  begin
    case (iFifo$D_OUT[6:4])
      3'd0:
	  ...
	  CASE_iFifoD_OUT_BITS_6_TO_4_0_CASE_guard32950_ETC__q82 =
	      iFifo$D_OUT[38];
      default: CASE_iFifoD_OUT_BITS_6_TO_4_0_CASE_guard32950_ETC__q82 =
  ...
  always@(rmdFifo$D_OUT or
	  resWire$wget or
	  CASE_guard96096_0b0_resWirewget_BIT_68_0b1_re_ETC__q149 or
	  guard__h296096)
  begin
    case (rmdFifo$D_OUT)
      3'd0:
  ...
  always@(rmdFifo$D_OUT or
	  resWire$wget or
	  CASE_guard87260_0b0_NOT_resWirewget_BIT_68_0b_ETC__q150 or
	  guard__h287260)
  begin
    case (rmdFifo$D_OUT)
      3'd0:
