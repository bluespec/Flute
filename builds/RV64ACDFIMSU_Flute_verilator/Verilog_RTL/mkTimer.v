...
//
// On Wed Jan  9 19:18:45 EST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkTimer(CLK,
  ...
  reg [31 : 0] v__h1835,
	       ...
	       v__h9274,
	       v__h9280;
  reg [1 : 0] CASE_byte_addr321_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1;
  wire [63 : 0] byte_addr__h2321,
		byte_addr__h2971,
		mask__h3285,
		mask__h5782,
		new_data__h5780,
		...
		y__h5794,
		y__h5795;
  wire [7 : 0] SEXT_slave_xactor_f_wr_data_first__7_BIT_0_35___d136,
	       SEXT_slave_xactor_f_wr_data_first__7_BIT_1_32___d133,
	       SEXT_slave_xactor_f_wr_data_first__7_BIT_2_28___d129,
	       SEXT_slave_xactor_f_wr_data_first__7_BIT_3_25___d126,
	       SEXT_slave_xactor_f_wr_data_first__7_BIT_4_21___d122,
	       SEXT_slave_xactor_f_wr_data_first__7_BIT_5_18___d119,
	       SEXT_slave_xactor_f_wr_data_first__7_BIT_6_14___d115,
	       SEXT_slave_xactor_f_wr_data_first__7_BIT_7_11___d112;
  wire NOT_cfg_verbosity_read_ULE_1_4___d25,
       NOT_crg_time_port0__read__0_ULT_crg_timecmp_po_ETC___d19,
       rg_msip_4_EQ_slave_xactor_f_wr_data_first__7_B_ETC___d89;
  ...
  assign MUX_rg_msip$write_1__SEL_2 =
	     WILL_FIRE_RL_rl_process_wr_req && byte_addr__h2971 == 64'h0 &&
	     !rg_msip_4_EQ_slave_xactor_f_wr_data_first__7_B_ETC___d89 ;
  assign MUX_crg_time$port1__write_1__VAL_2 =
	     (byte_addr__h2971 == 64'h000000000000BFF8) ?
	       new_time__h4527 :
	       new_time__h7052 ;
  assign MUX_crg_timecmp$port1__write_1__VAL_2 =
	     (byte_addr__h2971 == 64'h0000000000004000) ?
	       new_timecmp__h3254 :
	       new_timecmp__h5751 ;
  ...
  assign crg_time$EN_port1__write =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     (byte_addr__h2971 == 64'h000000000000BFF8 ||
	      byte_addr__h2971 == 64'h000000000000BFFC) ||
	     WILL_FIRE_RL_rl_reset ;
  ...
  assign crg_timecmp$EN_port1__write =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     (byte_addr__h2971 == 64'h0000000000004000 ||
	      byte_addr__h2971 == 64'h0000000000004004) ||
	     WILL_FIRE_RL_rl_reset ;
  ...
  assign slave_xactor_f_rd_data$D_IN =
	     { CASE_byte_addr321_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1,
	       rdr_rdata__h2538 } ;
  ...
  // submodule slave_xactor_f_wr_resp
  always@(byte_addr__h2971)
  begin
    case (byte_addr__h2971)
      64'h0,
  ...
  assign SEXT_slave_xactor_f_wr_data_first__7_BIT_0_35___d136 =
	     {8{slave_xactor_f_wr_data$D_OUT[0]}} ;
  assign SEXT_slave_xactor_f_wr_data_first__7_BIT_1_32___d133 =
	     {8{slave_xactor_f_wr_data$D_OUT[1]}} ;
  assign SEXT_slave_xactor_f_wr_data_first__7_BIT_2_28___d129 =
	     {8{slave_xactor_f_wr_data$D_OUT[2]}} ;
  assign SEXT_slave_xactor_f_wr_data_first__7_BIT_3_25___d126 =
	     {8{slave_xactor_f_wr_data$D_OUT[3]}} ;
  assign SEXT_slave_xactor_f_wr_data_first__7_BIT_4_21___d122 =
	     {8{slave_xactor_f_wr_data$D_OUT[4]}} ;
  assign SEXT_slave_xactor_f_wr_data_first__7_BIT_5_18___d119 =
	     {8{slave_xactor_f_wr_data$D_OUT[5]}} ;
  assign SEXT_slave_xactor_f_wr_data_first__7_BIT_6_14___d115 =
	     {8{slave_xactor_f_wr_data$D_OUT[6]}} ;
  assign SEXT_slave_xactor_f_wr_data_first__7_BIT_7_11___d112 =
	     {8{slave_xactor_f_wr_data$D_OUT[7]}} ;
  assign byte_addr__h2321 =
	     slave_xactor_f_rd_addr$D_OUT[66:3] - rg_addr_base ;
  assign byte_addr__h2971 =
  ...
  assign mask__h3285 =
	     { SEXT_slave_xactor_f_wr_data_first__7_BIT_7_11___d112,
	       ...
	       SEXT_slave_xactor_f_wr_data_first__7_BIT_2_28___d129,
	       SEXT_slave_xactor_f_wr_data_first__7_BIT_1_32___d133,
	       SEXT_slave_xactor_f_wr_data_first__7_BIT_0_35___d136 } ;
  assign mask__h5782 =
	     { SEXT_slave_xactor_f_wr_data_first__7_BIT_3_25___d126,
	       SEXT_slave_xactor_f_wr_data_first__7_BIT_2_28___d129,
	       SEXT_slave_xactor_f_wr_data_first__7_BIT_1_32___d133,
	       SEXT_slave_xactor_f_wr_data_first__7_BIT_0_35___d136,
	       32'd0 } ;
  assign new_data__h5780 = { slave_xactor_f_wr_data$D_OUT[39:8], 32'h0 } ;
  assign new_time__h4527 = x__h4569 | y__h3297 ;
  assign new_time__h7052 = x__h7094 | y__h5794 ;
  assign new_timecmp__h3254 = x__h3296 | y__h3297 ;
  assign new_timecmp__h5751 = x__h5793 | y__h5794 ;
  assign old_time__h7051 =
	     CAN_FIRE_RL_rl_tick_timer ? crg_time$port0__write_1 : crg_time ;
  assign rdata__h2336 = { 63'd0, rg_msip } ;
  assign rdata__h2360 = { 32'd0, crg_timecmp[63:32] } ;
  assign rdata__h2366 = { 32'd0, crg_time[63:32] } ;
  assign rg_msip_4_EQ_slave_xactor_f_wr_data_first__7_B_ETC___d89 =
	     rg_msip == slave_xactor_f_wr_data$D_OUT[8] ;
  assign x__h3296 = crg_timecmp & y__h3298 ;
  assign x__h4569 = old_time__h7051 & y__h3298 ;
  assign x__h5793 = crg_timecmp & y__h5795 ;
  assign x__h7094 = old_time__h7051 & y__h5795 ;
  assign y__h3297 = slave_xactor_f_wr_data$D_OUT[71:8] & mask__h3285 ;
  assign y__h3298 =
	     { ~SEXT_slave_xactor_f_wr_data_first__7_BIT_7_11___d112,
	       ~SEXT_slave_xactor_f_wr_data_first__7_BIT_6_14___d115,
	       ~SEXT_slave_xactor_f_wr_data_first__7_BIT_5_18___d119,
	       ...
	       ~SEXT_slave_xactor_f_wr_data_first__7_BIT_1_32___d133,
	       ~SEXT_slave_xactor_f_wr_data_first__7_BIT_0_35___d136 } ;
  assign y__h5794 = new_data__h5780 & mask__h5782 ;
  assign y__h5795 =
	     { ~SEXT_slave_xactor_f_wr_data_first__7_BIT_3_25___d126,
	       ~SEXT_slave_xactor_f_wr_data_first__7_BIT_2_28___d129,
	       ~SEXT_slave_xactor_f_wr_data_first__7_BIT_1_32___d133,
	       ~SEXT_slave_xactor_f_wr_data_first__7_BIT_0_35___d136,
	       32'hFFFFFFFF } ;
  always@(byte_addr__h2321 or
	  rdata__h2336 or
	  crg_timecmp or rdata__h2360 or crg_time or rdata__h2366)
  begin
    case (byte_addr__h2321)
      64'h0: rdr_rdata__h2538 = rdata__h2336;
      64'h0000000000000004: rdr_rdata__h2538 = 64'd0;
      64'h0000000000004000: rdr_rdata__h2538 = crg_timecmp;
      64'h0000000000004004: rdr_rdata__h2538 = rdata__h2360;
      64'h000000000000BFF8: rdr_rdata__h2538 = crg_time;
      64'h000000000000BFFC: rdr_rdata__h2538 = rdata__h2366;
      default: rdr_rdata__h2538 = 64'd0;
    endcase
  end
  always@(byte_addr__h2321)
  begin
    case (byte_addr__h2321)
      64'h0,
      64'h0000000000000004,
      ...
      64'h000000000000BFF8,
      64'h000000000000BFFC:
	  CASE_byte_addr321_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1 = 2'd0;
      default: CASE_byte_addr321_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1 = 2'd2;
    endcase
  end
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
	$display("%0d: Timer.rl_process_rd_req: rg_mtip = %0d",
		 v__h2215,
		 rg_mtip);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	...
	$write("\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req && byte_addr__h2321 != 64'h0 &&
	  byte_addr__h2321 != 64'h0000000000004000 &&
	  byte_addr__h2321 != 64'h000000000000BFF8 &&
	  byte_addr__h2321 != 64'h0000000000000004 &&
	  byte_addr__h2321 != 64'h0000000000004004 &&
	  byte_addr__h2321 != 64'h000000000000BFFC)
	begin
	  v__h2405 = $stime;
	  #0;
	end
    v__h2399 = v__h2405 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req && byte_addr__h2321 != 64'h0 &&
	  byte_addr__h2321 != 64'h0000000000004000 &&
	  byte_addr__h2321 != 64'h000000000000BFF8 &&
    ...
    v__h2835 = v__h2841 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
	$display("%0d: Timer.rl_process_wr_req: rg_mtip = %0d",
		 v__h2835,
		 rg_mtip);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	...
	$write("\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req && byte_addr__h2971 == 64'h0 &&
	  !rg_msip_4_EQ_slave_xactor_f_wr_data_first__7_B_ETC___d89 &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
	$display("    new MSIP = %0d", slave_xactor_f_wr_data$D_OUT[8]);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  byte_addr__h2971 == 64'h0000000000004000 &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  byte_addr__h2971 == 64'h0000000000004000 &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
	$display("        new MTIMECMP         = 0x%0h", new_timecmp__h3254);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  byte_addr__h2971 == 64'h0000000000004000 &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
	$display("        cur MTIME            = 0x%0h", old_time__h7051);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  byte_addr__h2971 == 64'h0000000000004000 &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
	$display("        new MTIMECMP - MTIME = 0x%0h",
		 new_timecmp__h3254 - old_time__h7051);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  byte_addr__h2971 == 64'h000000000000BFF8 &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  byte_addr__h2971 == 64'h000000000000BFF8 &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
	$display("        old MTIME = 0x%0h", old_time__h7051);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  byte_addr__h2971 == 64'h000000000000BFF8 &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
	$display("        new MTIME = 0x%0h", new_time__h4527);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  byte_addr__h2971 == 64'h0000000000004004 &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  byte_addr__h2971 == 64'h0000000000004004 &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
	$display("        new MTIMECMP         = 0x%0h", new_timecmp__h5751);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  byte_addr__h2971 == 64'h0000000000004004 &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
	$display("        new MTIMECMP - MTIME = 0x%0h",
		 new_timecmp__h5751 - old_time__h7051);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  byte_addr__h2971 == 64'h000000000000BFFC &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  byte_addr__h2971 == 64'h000000000000BFFC &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
	$display("        new MTIME = 0x%0h", new_time__h7052);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req && byte_addr__h2971 != 64'h0 &&
	  byte_addr__h2971 != 64'h0000000000004000 &&
	  byte_addr__h2971 != 64'h000000000000BFF8 &&
	  byte_addr__h2971 != 64'h0000000000000004 &&
	  byte_addr__h2971 != 64'h0000000000004004 &&
	  byte_addr__h2971 != 64'h000000000000BFFC)
	begin
	  v__h8310 = $stime;
    ...
    v__h1835 = v__h1841 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset && cfg_verbosity != 4'd0)
	$display("%0d: Timer.rl_reset", v__h1835);
  end
  // synopsys translate_on
endmodule  // mkTimer
