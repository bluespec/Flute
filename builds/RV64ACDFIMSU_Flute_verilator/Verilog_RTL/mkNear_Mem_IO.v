...
//
// On Fri Jan 11 23:38:40 EST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkNear_Mem_IO(CLK,
  ...
  wire [63 : 0] byte_addr__h1963,
		...
		y__h5354,
		y__h5355;
  wire [7 : 0] SEXT_f_reqs_first__3_BIT_0_26___d127,
	       SEXT_f_reqs_first__3_BIT_1_23___d124,
	       SEXT_f_reqs_first__3_BIT_2_19___d120,
	       SEXT_f_reqs_first__3_BIT_3_16___d117,
	       SEXT_f_reqs_first__3_BIT_4_12___d113,
	       SEXT_f_reqs_first__3_BIT_5_09___d110,
	       SEXT_f_reqs_first__3_BIT_6_05___d106,
	       SEXT_f_reqs_first__3_BIT_7_02___d103;
  wire NOT_cfg_verbosity_read_ULE_1_6___d27,
       NOT_crg_time_port0__read__2_ULT_crg_timecmp_po_ETC___d21,
       rg_msip_8_EQ_f_reqs_first__3_BIT_8_3___d84;
  ...
  assign MUX_crg_time$port1__write_1__SEL_1 =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     (byte_addr__h1963 == 64'h000000000000BFF8 ||
	      byte_addr__h1963 == 64'h000000000000BFFC) ;
  assign MUX_crg_timecmp$port1__write_1__SEL_1 =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     (byte_addr__h1963 == 64'h0000000000004000 ||
	      byte_addr__h1963 == 64'h0000000000004004) ;
  assign MUX_rg_msip$write_1__SEL_1 =
	     WILL_FIRE_RL_rl_process_wr_req && byte_addr__h1963 == 64'h0 &&
	     !rg_msip_8_EQ_f_reqs_first__3_BIT_8_3___d84 ;
  ...
  assign MUX_f_rsps$enq_1__VAL_1 =
	     { 1'd1,
	       ...
	       byte_addr__h1963 == 64'h0000000000004000 ||
	       byte_addr__h1963 == 64'h000000000000BFF8 ||
	       byte_addr__h1963 == 64'h0000000000000004 ||
	       byte_addr__h1963 == 64'h0000000000004004 ||
	       byte_addr__h1963 == 64'h000000000000BFFC,
	       rsp_rdata__h2191 } ;
  ...
  // remaining internal signals
  assign NOT_cfg_verbosity_read_ULE_1_6___d27 = cfg_verbosity > 4'd1 ;
  assign NOT_crg_time_port0__read__2_ULT_crg_timecmp_po_ETC___d21 =
	     crg_time >= crg_timecmp ;
  assign SEXT_f_reqs_first__3_BIT_0_26___d127 = {8{f_reqs$D_OUT[0]}} ;
  assign SEXT_f_reqs_first__3_BIT_1_23___d124 = {8{f_reqs$D_OUT[1]}} ;
  assign SEXT_f_reqs_first__3_BIT_2_19___d120 = {8{f_reqs$D_OUT[2]}} ;
  assign SEXT_f_reqs_first__3_BIT_3_16___d117 = {8{f_reqs$D_OUT[3]}} ;
  assign SEXT_f_reqs_first__3_BIT_4_12___d113 = {8{f_reqs$D_OUT[4]}} ;
  assign SEXT_f_reqs_first__3_BIT_5_09___d110 = {8{f_reqs$D_OUT[5]}} ;
  assign SEXT_f_reqs_first__3_BIT_6_05___d106 = {8{f_reqs$D_OUT[6]}} ;
  assign SEXT_f_reqs_first__3_BIT_7_02___d103 = {8{f_reqs$D_OUT[7]}} ;
  assign byte_addr__h1963 = f_reqs$D_OUT[135:72] - rg_addr_base ;
  assign mask__h2845 =
	     { SEXT_f_reqs_first__3_BIT_7_02___d103,
	       SEXT_f_reqs_first__3_BIT_6_05___d106,
	       SEXT_f_reqs_first__3_BIT_5_09___d110,
	       ...
	       SEXT_f_reqs_first__3_BIT_2_19___d120,
	       SEXT_f_reqs_first__3_BIT_1_23___d124,
	       SEXT_f_reqs_first__3_BIT_0_26___d127 } ;
  assign mask__h5342 =
	     { SEXT_f_reqs_first__3_BIT_3_16___d117,
	       SEXT_f_reqs_first__3_BIT_2_19___d120,
	       SEXT_f_reqs_first__3_BIT_1_23___d124,
	       SEXT_f_reqs_first__3_BIT_0_26___d127,
	       32'd0 } ;
  assign new_data__h5340 = { f_reqs$D_OUT[39:8], 32'h0 } ;
  assign new_time__h4087 = x__h4129 | y__h2857 ;
  assign new_time__h6612 = x__h6654 | y__h5354 ;
  assign new_timecmp__h2814 = x__h2856 | y__h2857 ;
  assign new_timecmp__h5311 = x__h5353 | y__h5354 ;
  assign old_time__h6611 =
	     CAN_FIRE_RL_rl_tick_timer ? crg_time$port0__write_1 : crg_time ;
  assign rdata__h1978 = { 63'd0, rg_msip } ;
  assign rdata__h2002 = { 32'd0, crg_timecmp[63:32] } ;
  assign rdata__h2008 = { 32'd0, crg_time[63:32] } ;
  assign rg_msip_8_EQ_f_reqs_first__3_BIT_8_3___d84 =
	     rg_msip == f_reqs$D_OUT[8] ;
  assign x__h2856 = crg_timecmp & y__h2858 ;
  assign x__h4129 = old_time__h6611 & y__h2858 ;
  assign x__h5353 = crg_timecmp & y__h5355 ;
  assign x__h6654 = old_time__h6611 & y__h5355 ;
  assign y__h2857 = f_reqs$D_OUT[71:8] & mask__h2845 ;
  assign y__h2858 =
	     { ~SEXT_f_reqs_first__3_BIT_7_02___d103,
	       ~SEXT_f_reqs_first__3_BIT_6_05___d106,
	       ~SEXT_f_reqs_first__3_BIT_5_09___d110,
	       ...
	       ~SEXT_f_reqs_first__3_BIT_1_23___d124,
	       ~SEXT_f_reqs_first__3_BIT_0_26___d127 } ;
  assign y__h5354 = new_data__h5340 & mask__h5342 ;
  assign y__h5355 =
	     { ~SEXT_f_reqs_first__3_BIT_3_16___d117,
	       ~SEXT_f_reqs_first__3_BIT_2_19___d120,
	       ~SEXT_f_reqs_first__3_BIT_1_23___d124,
	       ~SEXT_f_reqs_first__3_BIT_0_26___d127,
	       32'hFFFFFFFF } ;
  always@(byte_addr__h1963 or
	  rdata__h1978 or
	  crg_timecmp or rdata__h2002 or crg_time or rdata__h2008)
  begin
    case (byte_addr__h1963)
      64'h0: rsp_rdata__h2191 = rdata__h1978;
      64'h0000000000000004: rsp_rdata__h2191 = 64'd0;
      64'h0000000000004000: rsp_rdata__h2191 = crg_timecmp;
      64'h0000000000004004: rsp_rdata__h2191 = rdata__h2002;
      64'h000000000000BFF8: rsp_rdata__h2191 = crg_time;
      64'h000000000000BFFC: rsp_rdata__h2191 = rdata__h2008;
      default: rsp_rdata__h2191 = 64'd0;
    endcase
  end
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  NOT_cfg_verbosity_read_ULE_1_6___d27)
	begin
	  v__h8656 = $stime;
	  #0;
	end
    v__h8650 = v__h8656 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_get_timer_interrupt_req_get &&
	  NOT_cfg_verbosity_read_ULE_1_6___d27)
	$display("%0d: Near_Mem_IO: get_timer_interrupt_req: %x",
		 ...
		 f_timer_interrupt_req$D_OUT);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_get_sw_interrupt_req_get && NOT_cfg_verbosity_read_ULE_1_6___d27)
	begin
	  v__h8788 = $stime;
	  #0;
	end
    v__h8782 = v__h8788 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_get_sw_interrupt_req_get && NOT_cfg_verbosity_read_ULE_1_6___d27)
	...
	$write("\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req && byte_addr__h1963 != 64'h0 &&
	  byte_addr__h1963 != 64'h0000000000004000 &&
	  byte_addr__h1963 != 64'h000000000000BFF8 &&
	  byte_addr__h1963 != 64'h0000000000000004 &&
	  byte_addr__h1963 != 64'h0000000000004004 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read_ULE_1_6___d27)
	$write("'h%h", rsp_rdata__h2191, " }");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read_ULE_1_6___d27)
	$write("\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_compare && NOT_cfg_verbosity_read_ULE_1_6___d27)
	begin
	  v__h1698 = $stime;
	  #0;
	end
    v__h1692 = v__h1698 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_compare && NOT_cfg_verbosity_read_ULE_1_6___d27)
	...
	$write("\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req && byte_addr__h1963 == 64'h0 &&
	  !rg_msip_8_EQ_f_reqs_first__3_BIT_8_3___d84 &&
	  NOT_cfg_verbosity_read_ULE_1_6___d27)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  byte_addr__h1963 == 64'h0000000000004000 &&
	  NOT_cfg_verbosity_read_ULE_1_6___d27)
	$display("        new MTIMECMP         = 0x%0h", new_timecmp__h2814);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  byte_addr__h1963 == 64'h0000000000004000 &&
	  NOT_cfg_verbosity_read_ULE_1_6___d27)
	$display("        cur MTIME            = 0x%0h", old_time__h6611);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  byte_addr__h1963 == 64'h0000000000004000 &&
	  NOT_cfg_verbosity_read_ULE_1_6___d27)
	$display("        new MTIMECMP - MTIME = 0x%0h",
		 new_timecmp__h2814 - old_time__h6611);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  byte_addr__h1963 == 64'h000000000000BFF8 &&
	  NOT_cfg_verbosity_read_ULE_1_6___d27)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  byte_addr__h1963 == 64'h000000000000BFF8 &&
	  NOT_cfg_verbosity_read_ULE_1_6___d27)
	$display("        old MTIME = 0x%0h", old_time__h6611);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  byte_addr__h1963 == 64'h000000000000BFF8 &&
	  NOT_cfg_verbosity_read_ULE_1_6___d27)
	$display("        new MTIME = 0x%0h", new_time__h4087);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  byte_addr__h1963 == 64'h0000000000004004 &&
	  NOT_cfg_verbosity_read_ULE_1_6___d27)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  byte_addr__h1963 == 64'h0000000000004004 &&
	  NOT_cfg_verbosity_read_ULE_1_6___d27)
	$display("        new MTIMECMP         = 0x%0h", new_timecmp__h5311);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  byte_addr__h1963 == 64'h0000000000004004 &&
	  NOT_cfg_verbosity_read_ULE_1_6___d27)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  NOT_cfg_verbosity_read_ULE_1_6___d27)
	$display("        new MTIMECMP - MTIME = 0x%0h",
		 new_timecmp__h5311 - old_time__h6611);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  byte_addr__h1963 == 64'h000000000000BFFC &&
	  NOT_cfg_verbosity_read_ULE_1_6___d27)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  byte_addr__h1963 == 64'h000000000000BFFC &&
	  NOT_cfg_verbosity_read_ULE_1_6___d27)
	$display("        new MTIME = 0x%0h", new_time__h6612);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req && byte_addr__h1963 != 64'h0 &&
	  byte_addr__h1963 != 64'h0000000000004000 &&
	  byte_addr__h1963 != 64'h000000000000BFF8 &&
