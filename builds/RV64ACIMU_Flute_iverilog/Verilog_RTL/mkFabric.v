...
//
// On Fri Jan 18 20:42:20 EST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkFabric(CLK,
  ...
  begin
    ...
    v__h6404 = v__h6410 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (fabric_rg_reset)
	$display("%0d: AXI4_Lite_Fabric.rl_reset", v__h6404);
  end
  // synopsys translate_on
endmodule  // mkFabric
