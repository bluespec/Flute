...
//
// On Fri Jan 18 20:42:48 EST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkNear_Mem(CLK,
  ...
  reg [31 : 0] v__h1424, v__h1430, v__h1637, v__h1643;
  ...
  begin
    ...
    v__h1424 = v__h1430 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset && NOT_cfg_verbosity_read_ULE_1_0___d11)
	$display("%0d: Near_Mem.rl_reset", v__h1424);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_complete &&
	  NOT_cfg_verbosity_read_ULE_1_0___d11)
	$display("%0d: Near_Mem.rl_reset_complete", v__h1637);
  end
  // synopsys translate_on
