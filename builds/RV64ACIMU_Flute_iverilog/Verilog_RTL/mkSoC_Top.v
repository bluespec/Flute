...
//
// On Sat Jan 12 00:00:32 EST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkSoC_Top(CLK,
  ...
  reg [31 : 0] v__h6044, v__h6050, v__h6304, v__h6310;
  ...
  // submodule core
  mkCore #(.pc_reset_value(64'h0000000000001000),
	   .near_mem_io_addr_base(64'h0000000002000000),
	   .near_mem_io_addr_lim(64'h000000000200C000)) core(.CLK(CLK),
							     .RST_N(RST_N),
  ...
  assign core$cpu_external_interrupt_req_set_not_clear = 1'd0 ;
  ...
  begin
    ...
    v__h6044 = v__h6050 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_start_2)
	$display("%0d: SoC_Top. Reset start ...", v__h6044);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h6304 = v__h6310 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_complete)
	$display("%0d: SoC_Top. Reset complete ...", v__h6304);
  end
  // synopsys translate_on
endmodule  // mkSoC_Top
