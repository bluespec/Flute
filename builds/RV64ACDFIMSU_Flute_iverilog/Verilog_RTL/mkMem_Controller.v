...
//
// On Fri Jan 11 23:47:16 EST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkMem_Controller(CLK,
  ...
  reg [31 : 0] v__h10003,
	       ...
	       v__h9605,
	       v__h9997;
  wire [223 : 0] IF_n2051_BIT_2_THEN_IF_n2051_BIT_1_THEN_IF_n20_ETC__q2;
  wire [63 : 0] exit_value__h9002,
		f_reqs_rv_BITS_138_TO_75_MINUS_rg_addr_base__q1,
		mask__h7032,
		rdata__h4055,
		req_raw_mem_addr__h3029,
		updated_word64__h7033,
		x__h7406,
		y__h7407,
		y__h7408;
  wire [15 : 0] n2__h4050, n2__h4051;
  ...
  wire NOT_cfg_verbosity_read_ULE_1___d5,
       ...
       rg_state_EQ_3_3_AND_NOT_f_reqs_rv_port0__read__ETC___d239,
       rg_state_EQ_3_3_AND_f_reqs_rv_port0__read__2_B_ETC___d75,
       rg_watch_tohost_17_AND_f_reqs_rv_port0__read___ETC___d223;
  ...
  assign MUX_slave_xactor_f_rd_data$enq_1__VAL_1 = { 2'd0, rdata__h4055 } ;
  ...
  // remaining internal signals
  assign IF_n2051_BIT_2_THEN_IF_n2051_BIT_1_THEN_IF_n20_ETC__q2 =
	     n2__h4051[2] ?
	       (n2__h4051[1] ?
		  (n2__h4051[0] ?
  ...
  assign exit_value__h9002 = { 1'd0, f_reqs_rv[63:1] } ;
  ...
  assign n2__h4050 = { 13'd0, f_reqs_rv[79:77] } ;
  assign n2__h4051 = 16'd8 - n2__h4050 ;
  assign rdata__h4055 =
	     { IF_n2051_BIT_2_THEN_IF_n2051_BIT_1_THEN_IF_n20_ETC__q2[31:0],
	       n2__h4051[2] ?
		 (n2__h4051[1] ?
		    (n2__h4051[0] ?
		 ...
		 (n2__h4051[1] ?
		    ...
		    (n2__h4051[0] ?
		       rg_cached_raw_mem_word[255:224] :
		       rg_cached_raw_mem_word[31:0])) } ;
  assign req_raw_mem_addr__h3029 =
  ...
  assign rg_cached_raw_mem_addr_0_EQ_0_CONCAT_f_reqs_rv_ETC___d79 =
	     rg_cached_raw_mem_addr == req_raw_mem_addr__h3029 ;
  assign rg_state_EQ_3_3_AND_NOT_f_reqs_rv_port0__read__ETC___d239 =
	     rg_state == 2'd3 &&
  ...
  assign rg_state_EQ_3_3_AND_f_reqs_rv_port0__read__2_B_ETC___d75 =
	     ...
	     rg_addr_base_8_ULE_f_reqs_rv_port0__read__2_BI_ETC___d70 &&
	     f_reqs_rv_port0__read__2_BITS_138_TO_75_9_ULT__ETC___d72 ;
  assign rg_watch_tohost_17_AND_f_reqs_rv_port0__read___ETC___d223 =
	     rg_watch_tohost && f_reqs_rv[138:75] == rg_tohost_addr &&
	     f_reqs_rv[63:0] != 64'd0 ;
  assign updated_word64__h7033 = x__h7406 | y__h7407 ;
  assign x__h7406 = word64_old__h7027 & y__h7408 ;
  assign y__h7407 = f_reqs_rv[63:0] & mask__h7032 ;
  assign y__h7408 =
	     { ~SEXT_f_reqs_rv_port0__read__2_BIT_71_71___d172,
	       ~SEXT_f_reqs_rv_port0__read__2_BIT_70_74___d175,
	       ~SEXT_f_reqs_rv_port0__read__2_BIT_69_78___d179,
  ...
  begin
    case (f_reqs_rv[79:78])
      2'd0: word64_old__h7027 = rg_cached_raw_mem_word[63:0];
      2'd1: word64_old__h7027 = rg_cached_raw_mem_word[127:64];
      2'd2: word64_old__h7027 = rg_cached_raw_mem_word[191:128];
      2'd3: word64_old__h7027 = rg_cached_raw_mem_word[255:192];
    endcase
  end
  ...
  begin
    ...
    v__h6840 = v__h6846 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req && NOT_cfg_verbosity_read_ULE_1___d5)
	$display("%0d: Mem_Controller.rl_process_rd_req: ", v__h6840);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req && NOT_cfg_verbosity_read_ULE_1___d5)
	$write("        ");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h8780 = v__h8786 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req && NOT_cfg_verbosity_read_ULE_1___d5)
	$display("%0d: Mem_Controller.rl_process_wr_req: ", v__h8780);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req && NOT_cfg_verbosity_read_ULE_1___d5)
	$write("        ");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  rg_watch_tohost_17_AND_f_reqs_rv_port0__read___ETC___d223 &&
	  f_reqs_rv[63:1] != 63'd0)
	$display("FAIL %0d", exit_value__h9002);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  rg_watch_tohost_17_AND_f_reqs_rv_port0__read___ETC___d223)
    ...
    v__h9241 = v__h9247 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_invalid_rd_address)
	$write("%0d: ERROR: Mem_Controller:", v__h9241);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h9599 = v__h9605 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_invalid_wr_address)
	$write("%0d: ERROR: Mem_Controller:", v__h9599);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h2698 = v__h2704 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_rd_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$display("%0d: Mem_Controller.rl_merge_rd_req", v__h2698);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_rd_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$write("        ");
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_wr_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$display("%0d: Mem_Controller.rl_merge_wr_req", v__h2941);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_wr_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$write("        ");
