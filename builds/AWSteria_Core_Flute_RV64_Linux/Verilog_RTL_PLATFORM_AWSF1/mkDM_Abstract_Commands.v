...
module mkDM_Abstract_Commands(CLK,
  ...
  // register rg_data2
  reg [31 : 0] rg_data2;
  wire [31 : 0] rg_data2$D_IN;
  wire rg_data2$EN;

  // register rg_data3
  reg [31 : 0] rg_data3;
  wire [31 : 0] rg_data3$D_IN;
  wire rg_data3$EN;
  ...
  wire NOT_rg_abstractcs_busy_51_AND_write_dm_word_BI_ETC___d161,
       ...
       rg_abstractcs_cmderr_1_EQ_0_15_AND_write_dm_ad_ETC___d225,
       ...
       write_dm_addr_EQ_0x17_16_AND_NOT_rg_abstractcs_ETC___d155,
       write_dm_addr_EQ_0x17_16_AND_NOT_rg_abstractcs_ETC___d175;
  ...
  always@(av_read_dm_addr or
	  ...
	  rg_data0 or
	  rg_data1 or
	  rg_data2 or virt_rg_abstractcs__h774 or virt_rg_command__h824)
  begin
    case (av_read_dm_addr)
      7'h04: av_read = rg_data0;
      7'h05: av_read = rg_data1;
      7'h06: av_read = rg_data2;
      7'h16: av_read = virt_rg_abstractcs__h774;
      7'h17: av_read = virt_rg_command__h824;
      default: av_read = rg_data3;
    endcase
  end
  ...
  assign MUX_rg_abstractcs_busy$write_1__SEL_5 =
	     ...
	     write_dm_addr == 7'h17 &&
	     NOT_rg_abstractcs_busy_51_AND_write_dm_word_BI_ETC___d161 ;
  ...
  // register rg_data2
  assign rg_data2$D_IN = EN_reset ? 32'd0 : write_dm_word ;
  assign rg_data2$EN =
	     EN_write && rg_abstractcs_cmderr == 3'd0 &&
	     write_dm_addr == 7'h06 ||
	     EN_reset ;
  ...
  // register rg_data3
  assign rg_data3$D_IN = EN_reset ? 32'd0 : write_dm_word ;
  assign rg_data3$EN =
	     EN_write && rg_abstractcs_cmderr == 3'd0 &&
	     write_dm_addr == 7'h07 ||
	     EN_reset ;
  ...
  // remaining internal signals
  assign NOT_rg_abstractcs_busy_51_AND_write_dm_word_BI_ETC___d161 =
	     !rg_abstractcs_busy && write_dm_word[31:24] == 8'd0 &&
	     write_dm_word[22:20] == 3'd3 &&
	     !write_dm_word[18] &&
	     write_dm_word[17] ;
  assign NOT_rg_abstractcs_busy_51_AND_write_dm_word_BI_ETC___d170 =
	     !rg_abstractcs_busy && write_dm_word[31:24] == 8'd0 &&
	     write_dm_word[22:20] == 3'd3 &&
	     !write_dm_word[18] &&
	     !write_dm_word[17] ;
  ...
  assign rg_abstractcs_busy_AND_rg_start_reg_access_AND_ETC___d72 =
	     ...
	     !rg_command_access_reg_regno_ULT_0x1020___d57 &&
	     rg_command_access_reg_regno_ULE_0x103F___d59 ;
  assign rg_abstractcs_cmderr_1_EQ_0_15_AND_write_dm_ad_ETC___d225 =
  ...
  assign write_dm_addr_EQ_0x16_08_AND_rg_abstractcs_bus_ETC___d131 =
	     ...
	     write_dm_addr != 7'h06 &&
	     write_dm_addr != 7'h07 ;
  assign write_dm_addr_EQ_0x17_16_AND_NOT_rg_abstractcs_ETC___d155 =
	     write_dm_addr == 7'h17 && !rg_abstractcs_busy &&
	     write_dm_word[31:24] == 8'd0 &&
	     write_dm_word[22:20] == 3'd3 &&
	     write_dm_word[18] ;
  assign write_dm_addr_EQ_0x17_16_AND_NOT_rg_abstractcs_ETC___d175 =
	     write_dm_addr == 7'h17 && !rg_abstractcs_busy &&
	     write_dm_word[31:24] == 8'd0 &&
	     write_dm_word[22:20] != 3'd3 ;
  assign x__h1525 = rg_command_access_reg_regno - 13'h1000 ;
  assign x__h2106 = rg_command_access_reg_regno - 13'h1020 ;
  ...
  begin
    ...
    if (rg_data2$EN) rg_data2 <= `BSV_ASSIGNMENT_DELAY rg_data2$D_IN;
    if (rg_data3$EN) rg_data3 <= `BSV_ASSIGNMENT_DELAY rg_data3$D_IN;
  end
  ...
  begin
    ...
    rg_data2 = 32'hAAAAAAAA;
    rg_data3 = 32'hAAAAAAAA;
  ...
  begin
	...
	$write("DM_COMMAND_ACCESS_SIZE_UNDEF0");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && rg_abstractcs_cmderr == 3'd0 &&
	  write_dm_addr == 7'h17 &&
	  !rg_abstractcs_busy &&
	...
	$write("DM_COMMAND_ACCESS_SIZE_UNDEF1");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && rg_abstractcs_cmderr == 3'd0 &&
	  write_dm_addr == 7'h17 &&
	  !rg_abstractcs_busy &&
	...
	$write("DM_COMMAND_ACCESS_SIZE_LOWER32");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && rg_abstractcs_cmderr == 3'd0 &&
	  write_dm_addr == 7'h17 &&
	  !rg_abstractcs_busy &&
	...
	$write("DM_COMMAND_ACCESS_SIZE_LOWER128");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && rg_abstractcs_cmderr == 3'd0 &&
	  write_dm_addr == 7'h17 &&
	  !rg_abstractcs_busy &&
	...
	$write("DM_COMMAND_ACCESS_SIZE_UNDEF5");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && rg_abstractcs_cmderr == 3'd0 &&
	  write_dm_addr == 7'h17 &&
	  !rg_abstractcs_busy &&
	...
	$write("DM_COMMAND_ACCESS_SIZE_UNDEF6");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && rg_abstractcs_cmderr == 3'd0 &&
	  write_dm_addr == 7'h17 &&
	  !rg_abstractcs_busy &&
	  ...
	  write_dm_word[22:20] != 3'd5 &&
	  write_dm_word[22:20] != 3'd6)
	$write("DM_COMMAND_ACCESS_SIZE_UNDEF7");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && rg_abstractcs_cmderr == 3'd0 &&
	  write_dm_addr_EQ_0x17_16_AND_NOT_rg_abstractcs_ETC___d175)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  write_dm_addr == 7'h17 &&
	  !rg_abstractcs_busy &&
	  write_dm_word[31:24] == 8'd1)
	$write("DM_COMMAND_CMDTYPE_QUICK_ACCESS");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && rg_abstractcs_cmderr == 3'd0 &&
	  write_dm_addr == 7'h17 &&
	  !rg_abstractcs_busy &&
	  write_dm_word[31:24] == 8'd2)
	$write("DM_COMMAND_CMDTYPE_ACCESS_MEM");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && rg_abstractcs_cmderr == 3'd0 &&
	  write_dm_addr == 7'h17 &&
	  !rg_abstractcs_busy &&
	  ...
	  write_dm_word[31:24] != 8'd1 &&
	  write_dm_word[31:24] != 8'd2)
	$write("DM_COMMAND_CMDTYPE_UNKNOWN");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write &&
	  rg_abstractcs_cmderr_1_EQ_0_15_AND_write_dm_ad_ETC___d225)
	$write(" not supported", "\n");
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  write_dm_addr != 7'h06 &&
	  write_dm_addr != 7'h07)
	$write("Debug Module: DM_Abstract_Commands.write: [");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr != 7'h16 && rg_abstractcs_cmderr != 3'd0)
	$write("ERROR: Debug Module: Abstract Command write: [");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && rg_abstractcs_cmderr != 3'd0 && write_dm_addr == 7'h10)
	$write("dm_addr_dmcontrol");
    if (RST_N != `BSV_RESET_VALUE)
	...
	$write("dm_addr_haltregion31");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && rg_abstractcs_cmderr != 3'd0 && write_dm_addr == 7'h17)
	$write("dm_addr_command");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && rg_abstractcs_cmderr != 3'd0 && write_dm_addr == 7'h04)
	$write("dm_addr_data0");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr != 7'h16 && rg_abstractcs_cmderr != 3'd0)
	$write("]", " <= 0x%08h", write_dm_word, "\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr != 7'h16 && rg_abstractcs_cmderr != 3'd0)
	$write("    Ignoring due to previous cmderr ");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr != 7'h16 && rg_abstractcs_cmderr == 3'd1)
	$write("DM_ABSTRACTCS_CMDERR_BUSY");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr != 7'h16 && rg_abstractcs_cmderr == 3'd2)
	$write("DM_ABSTRACTCS_CMDERR_NOT_SUPPORTED");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr != 7'h16 && rg_abstractcs_cmderr == 3'd3)
	$write("DM_ABSTRACTCS_CMDERR_EXCEPTION");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr != 7'h16 && rg_abstractcs_cmderr == 3'd4)
	$write("DM_ABSTRACTCS_CMDERR_HALT_RESUME");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr != 7'h16 && rg_abstractcs_cmderr == 3'd5)
	$write("DM_ABSTRACTCS_CMDERR_UNDEF5");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr != 7'h16 && rg_abstractcs_cmderr == 3'd6)
	$write("DM_ABSTRACTCS_CMDERR_UNDEF6");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr != 7'h16 &&
	  rg_abstractcs_cmderr != 3'd0 &&
	  rg_abstractcs_cmderr != 3'd1 &&
	  rg_abstractcs_cmderr != 3'd2 &&
	  rg_abstractcs_cmderr != 3'd3 &&
	  rg_abstractcs_cmderr != 3'd4 &&
	  rg_abstractcs_cmderr != 3'd5 &&
	  rg_abstractcs_cmderr != 3'd6)
	$write("DM_ABSTRACTCS_CMDERR_OTHER");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr != 7'h16 && rg_abstractcs_cmderr != 3'd0)
	$write("\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_unknown_write_start)
