...
module mkD_MMU_Cache(CLK,
  ...
  wire NOT_crg_mmu_cache_req_port0__read__05_BITS_204_ETC___d128,
       ...
       tlb_mv_vm_xlate_crg_mmu_cache_req_port0__read__ETC___d178;
  ...
  assign MUX_crg_state$port0__write_1__VAL_1 =
	     (tlb$mv_vm_xlate[200:199] == 2'd1) ?
	       4'd5 :
	       IF_NOT_tlb_mv_vm_xlate_crg_mmu_cache_req_port0_ETC___d204 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      MUX_crg_exc$port0__write_1__SEL_2:
	  crg_exc_code$port0__write_1 = x1__h4889;
      MUX_crg_exc$port0__write_1__SEL_3:
	  crg_exc_code$port0__write_1 =
	      MUX_crg_exc_code$port0__write_1__VAL_3;
      WILL_FIRE_RL_rl_CPU_req_mmio_WAIT:
  ...
  // remaining internal signals
  assign IF_NOT_tlb_mv_vm_xlate_crg_mmu_cache_req_port0_ETC___d204 =
	     (!tlb_mv_vm_xlate_crg_mmu_cache_req_port0__read__ETC___d150 &&
	      tlb_mv_vm_xlate_crg_mmu_cache_req_port0__read__ETC___d151) ?
  ...
  assign NOT_crg_mmu_cache_req_port0__read__05_BITS_204_ETC___d159 =
	     NOT_crg_mmu_cache_req_port0__read__05_BITS_204_ETC___d128 ||
	     ((tlb$mv_vm_xlate[200:199] == 2'd1) ?
		ptw$RDY_dmem_server_request_put :
		tlb$mv_vm_xlate[200:199] == 2'd2 ||
  ...
  assign NOT_tlb_mv_vm_xlate_crg_mmu_cache_req_port0__r_ETC___d156 =
	     ...
	     (tlb_mv_vm_xlate_crg_mmu_cache_req_port0__read__ETC___d150 ||
	      !tlb_mv_vm_xlate_crg_mmu_cache_req_port0__read__ETC___d151 ||
	      cache$RDY_mav_request_pa) ;
  assign NOT_tlb_mv_vm_xlate_crg_mmu_cache_req_port0__r_ETC___d200 =
	     tlb$mv_vm_xlate[200:199] != 2'd2 &&
	     (cache$mav_request_pa[129:128] == 2'd0 ||
	      cache$mav_request_pa[129:128] == 2'd2 ||
	      tlb_mv_vm_xlate_crg_mmu_cache_req_port0__read__ETC___d150 ||
	      !tlb_mv_vm_xlate_crg_mmu_cache_req_port0__read__ETC___d151) ;
  assign NOT_tlb_mv_vm_xlate_crg_mmu_cache_req_port0__r_ETC___d225 =
	     tlb$mv_vm_xlate[200:199] != 2'd2 &&
	     !tlb_mv_vm_xlate_crg_mmu_cache_req_port0__read__ETC___d150 &&
	     tlb_mv_vm_xlate_crg_mmu_cache_req_port0__read__ETC___d151 &&
	     cache$mav_request_pa[129:128] != 2'd0 ;
  assign NOT_tlb_mv_vm_xlate_crg_mmu_cache_req_port0__r_ETC___d237 =
	     tlb$mv_vm_xlate[200:199] != 2'd2 && rg_watch_tohost &&
	     tlb$mv_vm_xlate[198:135] == rg_tohost_addr ;
  assign crg_mmu_cache_req_port0__read__05_BITS_204_TO__ETC___d196 =
	     crg_mmu_cache_req[204:203] == 2'b0 ||
	     ...
	     crg_mmu_cache_req[204:203] == 2'b11 &&
	     crg_mmu_cache_req[141:139] == 3'b0 ;
  assign crg_mmu_cache_req_port0__read__05_BITS_204_TO__ETC___d224 =
	     crg_mmu_cache_req_port0__read__05_BITS_204_TO__ETC___d196 &&
	     tlb$mv_vm_xlate[200:199] != 2'd1 &&
	     tlb$mv_vm_xlate[200:199] != 2'd2 &&
	     !tlb_mv_vm_xlate_crg_mmu_cache_req_port0__read__ETC___d150 &&
  ...
  assign rg_watch_tohost_33_AND_tlb_mv_vm_xlate_crg_mmu_ETC___d257 =
	     ...
	     NOT_rg_tohost_value_41_EQ_crg_mmu_cache_req_po_ETC___d243 &&
	     crg_mmu_cache_req[138:76] != 63'd0 ;
  assign test_num__h4631 = { 1'd0, crg_mmu_cache_req[138:76] } ;
  ...
  assign tlb_mv_vm_xlate_crg_mmu_cache_req_port0__read__ETC___d171 =
	     tlb$mv_vm_xlate[200:199] == 2'd2 ||
	     cache$mav_request_pa[129:128] == 2'd0 ||
	     cache$mav_request_pa[129:128] == 2'd1 ||
	     cache$mav_request_pa[129:128] == 2'd2 ||
	     tlb_mv_vm_xlate_crg_mmu_cache_req_port0__read__ETC___d150 ||
	     !tlb_mv_vm_xlate_crg_mmu_cache_req_port0__read__ETC___d151 ;
  assign tlb_mv_vm_xlate_crg_mmu_cache_req_port0__read__ETC___d178 =
	     tlb$mv_vm_xlate[200:199] == 2'd2 ||
	     !tlb_mv_vm_xlate_crg_mmu_cache_req_port0__read__ETC___d150 &&
	     tlb_mv_vm_xlate_crg_mmu_cache_req_port0__read__ETC___d151 &&
	     cache$mav_request_pa[129:128] == 2'd1 ;
  ...
  begin
	...
	$display("Dynamic assertion failed: \"/Users/nikhil/Git/Flute/src_Core/Near_Mem_VM_WB_L1_L2/D_MMU_Cache.bsv\", line 467, column 67\nFAIL: unknown vm_xlate result");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_CPU_req_B &&
	  crg_mmu_cache_req_port0__read__05_BITS_204_TO__ETC___d196 &&
	  tlb$mv_vm_xlate[200:199] != 2'd1 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  tlb$mv_vm_xlate[200:199] != 2'd2 &&
	  rg_watch_tohost_33_AND_tlb_mv_vm_xlate_crg_mmu_ETC___d257)
	$display("    = FAIL on test_%0d", test_num__h4631);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h6609 = v__h6615 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_ptw_rd_B && cache$mav_request_pa[129:128] == 2'd2)
	$display("%0d: %m.rl_ptw_rd_B", v__h6609);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_ptw_rd_B && cache$mav_request_pa[129:128] == 2'd2)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_ma_req && crg_mmu_cache_req_state$port1__read != 2'd0)
	$display("%0d: %m.rl_CPU_req", v__h2133);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_ma_req && crg_mmu_cache_req_state$port1__read != 2'd0)
