...
// RDY_fi_verbosity_control_enq   O     1 const
// fi_verbosity_control_notFull   O     1 const
// RDY_fi_verbosity_control_notFull  O     1 const
// RDY_fi_watch_tohost_control_enq  O     1 const
...
module mkAWSteria_Core_Inner(CLK,
			     RST_N,
  ...
  input  EN_fi_pc_trace_control_enq;
  output RDY_fi_pc_trace_control_enq;

  // value method fi_pc_trace_control_notFull
  output fi_pc_trace_control_notFull;
  output RDY_fi_pc_trace_control_notFull;

  // action method fi_verbosity_control_enq
  input  [67 : 0] fi_verbosity_control_enq_x;
  input  EN_fi_verbosity_control_enq;
  output RDY_fi_verbosity_control_enq;

  // value method fi_verbosity_control_notFull
  output fi_verbosity_control_notFull;
  output RDY_fi_verbosity_control_notFull;

  // action method fi_watch_tohost_control_enq
  input  [64 : 0] fi_watch_tohost_control_enq_x;
  input  EN_fi_watch_tohost_control_enq;
  output RDY_fi_watch_tohost_control_enq;

  // value method fi_watch_tohost_control_notFull
  output fi_watch_tohost_control_notFull;
  output RDY_fi_watch_tohost_control_notFull;

  // value method fo_tohost_value_first
  output [63 : 0] fo_tohost_value_first;
  output RDY_fo_tohost_value_first;

  // action method fo_tohost_value_deq
  input  EN_fo_tohost_value_deq;
  output RDY_fo_tohost_value_deq;

  // value method fo_tohost_value_notEmpty
  output fo_tohost_value_notEmpty;
  output RDY_fo_tohost_value_notEmpty;
  ...
  wire CAN_FIRE_RL_dm_tv_ifc_1_ClientServerRequest,
       ...
       CAN_FIRE_fi_nmi_enq,
       CAN_FIRE_fi_pc_trace_control_enq,
       CAN_FIRE_fi_verbosity_control_enq,
       CAN_FIRE_fi_watch_tohost_control_enq,
       ...
       WILL_FIRE_fi_pc_trace_control_enq,
       WILL_FIRE_fi_verbosity_control_enq,
       WILL_FIRE_fi_watch_tohost_control_enq,
  ...
  assign CAN_FIRE_fi_pc_trace_control_enq = 1'd0 ;
  assign WILL_FIRE_fi_pc_trace_control_enq = EN_fi_pc_trace_control_enq ;

  // value method fi_pc_trace_control_notFull
  assign fi_pc_trace_control_notFull = 1'd0 ;
  assign RDY_fi_pc_trace_control_notFull = 1'd1 ;

  // action method fi_verbosity_control_enq
  assign RDY_fi_verbosity_control_enq = 1'd1 ;
  assign CAN_FIRE_fi_verbosity_control_enq = 1'd1 ;
  assign WILL_FIRE_fi_verbosity_control_enq = EN_fi_verbosity_control_enq ;

  // value method fi_verbosity_control_notFull
  assign fi_verbosity_control_notFull = 1'd1 ;
  assign RDY_fi_verbosity_control_notFull = 1'd1 ;

  // action method fi_watch_tohost_control_enq
  assign RDY_fi_watch_tohost_control_enq = 1'd1 ;
  assign CAN_FIRE_fi_watch_tohost_control_enq = 1'd1 ;
  assign WILL_FIRE_fi_watch_tohost_control_enq =
	     EN_fi_watch_tohost_control_enq ;

  // value method fi_watch_tohost_control_notFull
  assign fi_watch_tohost_control_notFull = 1'd1 ;
  ...
  assign CAN_FIRE_RL_rl_relay_external_interrupt = rg_module_state == 2'd2 ;
  ...
  // register rg_module_state
  assign rg_module_state$D_IN =
	     WILL_FIRE_RL_rl_first_init_start ? 2'd1 : 2'd2 ;
  ...
  assign boot_rom$EN_set_addr_map = CAN_FIRE_RL_rl_first_init_finish ;
  ...
  assign cpu$set_verbosity_logdelay = fi_verbosity_control_enq_x[63:0] ;
  assign cpu$set_verbosity_verbosity = fi_verbosity_control_enq_x[67:64] ;
  assign cpu$set_watch_tohost_tohost_addr =
	     fi_watch_tohost_control_enq_x[63:0] ;
  assign cpu$set_watch_tohost_watch_tohost =
	     fi_watch_tohost_control_enq_x[64] ;
  ...
  assign mmio_fabric$EN_reset = CAN_FIRE_RL_rl_first_init_start ;
  ...
  assign near_mem_io$EN_server_reset_response_get =
	     CAN_FIRE_RL_rl_first_init_finish ;
  assign near_mem_io$EN_set_addr_map = CAN_FIRE_RL_rl_first_init_finish ;
  ...
  assign plic$EN_server_reset_request_put = CAN_FIRE_RL_rl_first_init_start ;
