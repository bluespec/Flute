...
module mkAWSteria_Core(CLK_clk1,
  ...
  SyncFIFO #(.dataWidth(32'd109),
	     .depth(32'd4),
	     .indxWidth(32'd2)) core_reclocked_ddr_AXI4_clock_crossing_f_ar(.sCLK(CLK_clk4),
									    .dCLK(CLK),
  ...
  SyncFIFO #(.dataWidth(32'd109),
	     .depth(32'd4),
	     .indxWidth(32'd2)) core_reclocked_ddr_AXI4_clock_crossing_f_aw(.sCLK(CLK_clk4),
									    .dCLK(CLK),
									    .sRST(reset_for_core$OUT_RST),
  ...
  SyncFIFO #(.dataWidth(32'd577),
	     .depth(32'd4),
	     .indxWidth(32'd2)) core_reclocked_ddr_AXI4_clock_crossing_f_w(.sCLK(CLK_clk4),
									   .dCLK(CLK),
									   .sRST(reset_for_core$OUT_RST),
  ...
  SyncFIFO #(.dataWidth(32'd18),
	     .depth(32'd4),
	     .indxWidth(32'd2)) core_reclocked_dma_AXI4_clock_crossing_f_b(.sCLK(CLK_clk4),
									   .dCLK(CLK),
									   .sRST(reset_for_core$OUT_RST),
  ...
  SyncFIFO #(.dataWidth(32'd531),
	     .depth(32'd4),
	     .indxWidth(32'd2)) core_reclocked_dma_AXI4_clock_crossing_f_r(.sCLK(CLK_clk4),
									   .dCLK(CLK),
									   .sRST(reset_for_core$OUT_RST),
  ...
  SyncFIFO #(.dataWidth(32'd32),
	     .depth(32'd4),
	     .indxWidth(32'd2)) core_reclocked_f_control_status_rsp(.sCLK(CLK_clk4),
								    .dCLK(CLK),
								    .sRST(reset_for_core$OUT_RST),
  ...
  SyncFIFO #(.dataWidth(32'd32),
	     .depth(32'd4),
	     .indxWidth(32'd2)) core_reclocked_f_dmi_rsp(.sCLK(CLK_clk4),
							 .dCLK(CLK),
							 .sRST(reset_for_core$OUT_RST),
  ...
  SyncFIFO #(.dataWidth(32'd32),
	     .depth(32'd4),
	     .indxWidth(32'd2)) core_reclocked_f_misc_to_host(.sCLK(CLK_clk4),
							      .dCLK(CLK),
							      .sRST(reset_for_core$OUT_RST),
  ...
  SyncFIFO0 #(.depth(32'd4),
	      .indxWidth(32'd2)) core_reclocked_f_ndm_reset_req(.sCLK(CLK_clk4),
								.dCLK(CLK),
								.sRST(reset_for_core$OUT_RST),
  ...
  SyncFIFO #(.dataWidth(32'd608),
	     .depth(32'd4),
	     .indxWidth(32'd2)) core_reclocked_f_tv_info(.sCLK(CLK_clk4),
							 .dCLK(CLK),
							 .sRST(reset_for_core$OUT_RST),
  ...
  SyncFIFO #(.dataWidth(32'd109),
	     .depth(32'd4),
	     .indxWidth(32'd2)) core_reclocked_mmio_AXI4_clock_crossing_f_ar(.sCLK(CLK_clk4),
									     .dCLK(CLK),
									     .sRST(reset_for_core$OUT_RST),
  ...
  SyncFIFO #(.dataWidth(32'd109),
	     .depth(32'd4),
	     .indxWidth(32'd2)) core_reclocked_mmio_AXI4_clock_crossing_f_aw(.sCLK(CLK_clk4),
									     .dCLK(CLK),
									     .sRST(reset_for_core$OUT_RST),
  ...
  SyncFIFO #(.dataWidth(32'd73),
	     .depth(32'd4),
	     .indxWidth(32'd2)) core_reclocked_mmio_AXI4_clock_crossing_f_w(.sCLK(CLK_clk4),
									    .dCLK(CLK),
									    .sRST(reset_for_core$OUT_RST),
  ...
  mkAWSteria_Core_Single_Clock core_single_clock(.CLK(CLK_clk4),
