...
//
// On Fri Jan 11 23:00:50 EST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkCore(CLK,
  ...
  // submodule cpu
  mkCPU #(.pc_reset_value(pc_reset_value),
	  .near_mem_io_addr_base(near_mem_io_addr_base),
	  .near_mem_io_addr_lim(near_mem_io_addr_lim)) cpu(.CLK(CLK),
							   .RST_N(RST_N),
