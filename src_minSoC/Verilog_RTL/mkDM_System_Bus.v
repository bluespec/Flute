...
module mkDM_System_Bus(CLK,
  ...
  reg [63 : 0] CASE_rg_sbcs_sbaccess_0_IF_rg_sbaddress_readin_ETC__q3,
	       IF_rg_sbaddress_reading_0_BITS_1_TO_0_1_EQ_0_2_ETC___d37,
	       IF_rg_sbaddress_reading_0_BITS_1_TO_0_1_EQ_0_2_ETC___d44,
	       IF_rg_sbcs_sbaccess_8_EQ_0_9_THEN_1_ELSE_IF_rg_ETC___d76,
	       word64__h4267;
  reg [7 : 0] strobe64__h4269;
  reg [2 : 0] x__h4280;
  wire [63 : 0] IF_rg_sbaddress_reading_0_BITS_1_TO_0_1_EQ_0_2_ETC___d49,
		_theResult_____1_fst__h4402,
		_theResult___fst__h4318,
		addr64630_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9_TH_ETC__q1,
		addr64__h3630,
		rdata64__h924,
		result__h1204,
		result__h1234,
		...
		result__h1337,
		result__h1364,
		sbaddress37_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9__ETC__q2,
		sbaddress__h637,
		word64__h4262,
		x__h4374;
  wire [31 : 0] IF_rg_sbcs_sbreadonaddr_93_THEN_IF_rg_sbcs_sba_ETC___d276,
		v__h1964,
		v__h2077;
  wire [7 : 0] strobe64___1__h4401,
	       strobe64__h4317,
	       strobe64__h4320,
	       strobe64__h4323,
	       x__h4511;
  wire [5 : 0] shift_bits__h4265;
  wire rg_sb_state_EQ_0_0_AND_NOT_rg_sbcs_sbbusyerror_ETC___d282,
       rg_sb_state_EQ_0_0_AND_NOT_rg_sbcs_sbbusyerror_ETC___d68,
       rg_sb_state_EQ_0_0_AND_NOT_rg_sbcs_sbbusyerror_ETC___d82,
       rg_sbcs_sberror_EQ_0_AND_rg_sbcs_sbreadonaddr__ETC___d260,
       write_dm_addr_EQ_0x38_10_AND_rg_sbcs_sberror_E_ETC___d225,
       write_dm_addr_EQ_0x38_10_AND_rg_sbcs_sberror_E_ETC___d234,
       write_dm_addr_EQ_0x38_10_AND_rg_sbcs_sberror_E_ETC___d240,
       write_dm_addr_EQ_0x38_10_AND_rg_sbcs_sberror_E_ETC___d242,
       write_dm_addr_EQ_0x38_10_AND_rg_sbcs_sberror_E_ETC___d247,
       write_dm_addr_EQ_0x3C_30_AND_rg_sb_state_EQ_0__ETC___d292;
  ...
  always@(av_read_dm_addr or
	  v__h1964 or rg_sbaddress0 or rg_sbaddress1 or v__h2077)
  begin
    case (av_read_dm_addr)
      7'h38: av_read = v__h1964;
      7'h39: av_read = rg_sbaddress0;
      7'h3A: av_read = rg_sbaddress1;
      7'h3C: av_read = v__h2077;
  ...
  // value method master_m_awid
  assign master_awid = master_xactor_f_wr_addr$D_OUT[64:61] ;

  // value method master_m_awaddr
  assign master_awaddr = master_xactor_f_wr_addr$D_OUT[60:29] ;
  ...
  // value method master_m_wdata
  assign master_wdata = master_xactor_f_wr_data$D_OUT[36:5] ;

  // value method master_m_wstrb
  assign master_wstrb = master_xactor_f_wr_data$D_OUT[4:1] ;
  ...
  // value method master_m_arid
  assign master_arid = master_xactor_f_rd_addr$D_OUT[64:61] ;

  // value method master_m_araddr
  assign master_araddr = master_xactor_f_rd_addr$D_OUT[60:29] ;
  ...
  assign CAN_FIRE_RL_rl_sb_read_finish = WILL_FIRE_RL_rl_sb_read_finish ;
  assign WILL_FIRE_RL_rl_sb_read_finish =
  ...
  assign MUX_master_xactor_f_rd_addr$enq_1__VAL_1 =
	     { 4'd0, rg_sbaddress0, 8'd0, rg_sbcs_sbaccess, 18'd65536 } ;
  assign MUX_master_xactor_f_rd_addr$enq_1__VAL_2 =
	     { 4'd0, write_dm_word, 8'd0, rg_sbcs_sbaccess, 18'd65536 } ;
  always@(write_dm_addr or
	  sbaddress37_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9__ETC__q2 or
	  IF_rg_sbcs_sbreadonaddr_93_THEN_IF_rg_sbcs_sba_ETC___d276)
  begin
    case (write_dm_addr)
      7'h39, 7'h3A:
      ...
      default: MUX_rg_sbaddress0$write_1__VAL_2 =
		   sbaddress37_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9__ETC__q2[31:0];
    endcase
  end
  ...
  assign rg_sb_state$EN =
	     ...
	     rg_sb_state_EQ_0_0_AND_NOT_rg_sbcs_sbbusyerror_ETC___d282 ||
	     WILL_FIRE_RL_rl_sb_read_finish ||
	     EN_reset ;
  ...
  always@(EN_reset or
	  ...
	  CASE_rg_sbcs_sbaccess_0_IF_rg_sbaddress_readin_ETC__q3 or
	  MUX_rg_sbdata0$write_1__SEL_3 or write_dm_word)
  case (1'b1)
    EN_reset: rg_sbdata0$D_IN = 32'd0;
    WILL_FIRE_RL_rl_sb_read_finish:
	rg_sbdata0$D_IN =
	    CASE_rg_sbcs_sbaccess_0_IF_rg_sbaddress_readin_ETC__q3[31:0];
  ...
  assign master_xactor_f_wr_addr$D_IN =
	     { 4'd0, rg_sbaddress0, 8'd0, x__h4280, 18'd65536 } ;
  ...
  assign master_xactor_f_wr_data$D_IN =
	     { x__h4374[31:0], x__h4511[3:0], 1'd1 } ;
  ...
  // remaining internal signals
  assign IF_rg_sbaddress_reading_0_BITS_1_TO_0_1_EQ_0_2_ETC___d49 =
	     (rg_sbaddress_reading[1:0] == 2'd0) ? rdata64__h924 : 64'd0 ;
  assign IF_rg_sbcs_sbreadonaddr_93_THEN_IF_rg_sbcs_sba_ETC___d276 =
	     rg_sbcs_sbreadonaddr ?
	       (rg_sbcs_sbautoincrement ?
		  addr64630_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9_TH_ETC__q1[31:0] :
		  write_dm_word) :
	       write_dm_word ;
  assign _theResult_____1_fst__h4402 = { 32'h0, word64__h4267[63:32] } ;
  assign _theResult___fst__h4318 = word64__h4262 << shift_bits__h4265 ;
  assign addr64630_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9_TH_ETC__q1 =
	     addr64__h3630 +
	     IF_rg_sbcs_sbaccess_8_EQ_0_9_THEN_1_ELSE_IF_rg_ETC___d76 ;
  assign addr64__h3630 = { rg_sbaddress1, write_dm_word } ;
  assign rdata64__h924 = { 32'd0, master_xactor_f_rd_data$D_OUT[34:3] } ;
  assign result__h1204 = { 56'd0, master_xactor_f_rd_data$D_OUT[10:3] } ;
  assign result__h1234 = { 56'd0, master_xactor_f_rd_data$D_OUT[18:11] } ;
  assign result__h1261 = { 56'd0, master_xactor_f_rd_data$D_OUT[26:19] } ;
  assign result__h1288 = { 56'd0, master_xactor_f_rd_data$D_OUT[34:27] } ;
  assign result__h1337 = { 48'd0, master_xactor_f_rd_data$D_OUT[18:3] } ;
  assign result__h1364 = { 48'd0, master_xactor_f_rd_data$D_OUT[34:19] } ;
  assign rg_sb_state_EQ_0_0_AND_NOT_rg_sbcs_sbbusyerror_ETC___d282 =
	     rg_sb_state == 2'd0 && !rg_sbcs_sbbusyerror &&
	     rg_sbcs_sberror == 3'd0 &&
	     rg_sbcs_sbreadonaddr ;
  assign rg_sb_state_EQ_0_0_AND_NOT_rg_sbcs_sbbusyerror_ETC___d68 =
	     rg_sb_state == 2'd0 && !rg_sbcs_sbbusyerror &&
	     rg_sbcs_sberror == 3'd0 &&
	     rg_sbcs_sbautoincrement ;
  assign rg_sb_state_EQ_0_0_AND_NOT_rg_sbcs_sbbusyerror_ETC___d82 =
	     rg_sb_state == 2'd0 && !rg_sbcs_sbbusyerror &&
	     rg_sbcs_sberror == 3'd0 &&
	     rg_sbcs_sbreadondata ;
  assign rg_sbcs_sberror_EQ_0_AND_rg_sbcs_sbreadonaddr__ETC___d260 =
	     rg_sbcs_sberror == 3'd0 &&
	     (rg_sbcs_sbreadonaddr && rg_sbcs_sbautoincrement ||
	      write_dm_addr != 7'h39) ;
  assign sbaddress37_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9__ETC__q2 =
	     sbaddress__h637 +
	     IF_rg_sbcs_sbaccess_8_EQ_0_9_THEN_1_ELSE_IF_rg_ETC___d76 ;
  assign sbaddress__h637 = { rg_sbaddress1, rg_sbaddress0 } ;
  assign shift_bits__h4265 = { rg_sbaddress0[2:0], 3'b0 } ;
  assign strobe64___1__h4401 = { 4'h0, strobe64__h4269[7:4] } ;
  assign strobe64__h4317 = 8'b00000001 << rg_sbaddress0[2:0] ;
  assign strobe64__h4320 = 8'b00000011 << rg_sbaddress0[2:0] ;
  assign strobe64__h4323 = 8'b00001111 << rg_sbaddress0[2:0] ;
  assign v__h1964 =
	     { 9'd64,
	       rg_sbcs_sbbusyerror,
	       rg_sb_state != 2'd0,
  ...
  assign v__h2077 =
	     (rg_sb_state != 2'd0 || rg_sbcs_sbbusyerror ||
	      rg_sbcs_sberror != 3'd0) ?
	       32'd0 :
	       rg_sbdata0 ;
  assign word64__h4262 = { 32'd0, write_dm_word } ;
  assign write_dm_addr_EQ_0x38_10_AND_rg_sbcs_sberror_E_ETC___d225 =
	     write_dm_addr == 7'h38 &&
  ...
  assign write_dm_addr_EQ_0x38_10_AND_rg_sbcs_sberror_E_ETC___d234 =
	     write_dm_addr_EQ_0x38_10_AND_rg_sbcs_sberror_E_ETC___d225 ||
	     (write_dm_addr == 7'h39 || write_dm_addr == 7'h3A ||
	      write_dm_addr == 7'h3C) &&
	     rg_sb_state != 2'd0 ;
  assign write_dm_addr_EQ_0x38_10_AND_rg_sbcs_sberror_E_ETC___d240 =
	     write_dm_addr == 7'h38 &&
	     (rg_sbcs_sberror == 3'd0 || write_dm_word[14:12] != 3'd0) &&
	     rg_sbcs_sbbusyerror &&
	     !write_dm_word[22] ;
  assign write_dm_addr_EQ_0x38_10_AND_rg_sbcs_sberror_E_ETC___d242 =
	     write_dm_addr == 7'h38 &&
	     (rg_sbcs_sberror == 3'd0 || write_dm_word[14:12] != 3'd0) &&
	     (!rg_sbcs_sbbusyerror || write_dm_word[22]) ;
  assign write_dm_addr_EQ_0x38_10_AND_rg_sbcs_sberror_E_ETC___d247 =
	     write_dm_addr == 7'h38 &&
	     (rg_sbcs_sberror == 3'd0 || write_dm_word[14:12] != 3'd0) &&
	     (!rg_sbcs_sbbusyerror || write_dm_word[22]) &&
	     (write_dm_word[19:17] == 3'd4 || write_dm_word[19:17] == 3'd3) ;
  assign write_dm_addr_EQ_0x3C_30_AND_rg_sb_state_EQ_0__ETC___d292 =
	     write_dm_addr == 7'h3C && rg_sb_state == 2'd0 &&
	     !rg_sbcs_sbbusyerror &&
	     rg_sbcs_sberror == 3'd0 ;
  assign x__h4374 =
	     rg_sbaddress0[2] ? _theResult_____1_fst__h4402 : word64__h4267 ;
  assign x__h4511 = rg_sbaddress0[2] ? strobe64___1__h4401 : strobe64__h4269 ;
  always@(rg_sbcs_sbaccess)
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2, 3'd3: x__h4280 = rg_sbcs_sbaccess;
      default: x__h4280 = 3'b111;
    endcase
  end
  always@(rg_sbcs_sbaccess or
	  strobe64__h4317 or strobe64__h4320 or strobe64__h4323)
  begin
    case (rg_sbcs_sbaccess)
      3'd0: strobe64__h4269 = strobe64__h4317;
      3'd1: strobe64__h4269 = strobe64__h4320;
      3'd2: strobe64__h4269 = strobe64__h4323;
      3'd3: strobe64__h4269 = 8'b11111111;
      default: strobe64__h4269 = 8'd0;
    endcase
  end
  always@(rg_sbcs_sbaccess or word64__h4262 or _theResult___fst__h4318)
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2: word64__h4267 = _theResult___fst__h4318;
      default: word64__h4267 = word64__h4262;
    endcase
  end
  always@(rg_sbcs_sbaccess)
  begin
    case (rg_sbcs_sbaccess)
      3'd0: IF_rg_sbcs_sbaccess_8_EQ_0_9_THEN_1_ELSE_IF_rg_ETC___d76 = 64'd1;
      3'd1: IF_rg_sbcs_sbaccess_8_EQ_0_9_THEN_1_ELSE_IF_rg_ETC___d76 = 64'd2;
      3'd2: IF_rg_sbcs_sbaccess_8_EQ_0_9_THEN_1_ELSE_IF_rg_ETC___d76 = 64'd4;
      3'd3: IF_rg_sbcs_sbaccess_8_EQ_0_9_THEN_1_ELSE_IF_rg_ETC___d76 = 64'd8;
      default: IF_rg_sbcs_sbaccess_8_EQ_0_9_THEN_1_ELSE_IF_rg_ETC___d76 =
		   64'd16;
    endcase
  end
  always@(rg_sbaddress_reading or
	  result__h1204 or result__h1234 or result__h1261 or result__h1288)
  begin
    case (rg_sbaddress_reading[1:0])
      2'd0:
	  IF_rg_sbaddress_reading_0_BITS_1_TO_0_1_EQ_0_2_ETC___d37 =
	      result__h1204;
      2'd1:
  ...
  always@(rg_sbaddress_reading or result__h1337 or result__h1364)
  begin
    case (rg_sbaddress_reading[1:0])
      2'd0:
	  IF_rg_sbaddress_reading_0_BITS_1_TO_0_1_EQ_0_2_ETC___d44 =
	  ...
	  IF_rg_sbaddress_reading_0_BITS_1_TO_0_1_EQ_0_2_ETC___d44 =
	      result__h1364;
      default: IF_rg_sbaddress_reading_0_BITS_1_TO_0_1_EQ_0_2_ETC___d44 =
		   64'd0;
    endcase
  end
  always@(rg_sbcs_sbaccess or
	  IF_rg_sbaddress_reading_0_BITS_1_TO_0_1_EQ_0_2_ETC___d37 or
	  IF_rg_sbaddress_reading_0_BITS_1_TO_0_1_EQ_0_2_ETC___d44 or
	  IF_rg_sbaddress_reading_0_BITS_1_TO_0_1_EQ_0_2_ETC___d49)
  begin
    case (rg_sbcs_sbaccess)
      3'd0:
	  CASE_rg_sbcs_sbaccess_0_IF_rg_sbaddress_readin_ETC__q3 =
	      IF_rg_sbaddress_reading_0_BITS_1_TO_0_1_EQ_0_2_ETC___d37;
      3'd1:
	  CASE_rg_sbcs_sbaccess_0_IF_rg_sbaddress_readin_ETC__q3 =
	      IF_rg_sbaddress_reading_0_BITS_1_TO_0_1_EQ_0_2_ETC___d44;
	  ...
	  CASE_rg_sbcs_sbaccess_0_IF_rg_sbaddress_readin_ETC__q3 =
	      IF_rg_sbaddress_reading_0_BITS_1_TO_0_1_EQ_0_2_ETC___d49;
      default: CASE_rg_sbcs_sbaccess_0_IF_rg_sbaddress_readin_ETC__q3 = 64'd0;
    endcase
  end
