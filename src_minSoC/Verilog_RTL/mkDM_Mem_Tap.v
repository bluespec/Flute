...
module mkDM_Mem_Tap(CLK,
  ...
  reg [31 : 0] CASE_slave_xactor_f_wr_dataD_OUT_BITS_4_TO_1__ETC__q1,
	       y__h1728;
  reg [1 : 0] sz__h1528;
  wire [63 : 0] paddr__h1516;
  wire [31 : 0] x__h1682, x__h1710, x__h1727;
  ...
  // value method slave_m_rid
  assign slave_rid = slave_xactor_f_rd_data$D_OUT[38:35] ;
  ...
  // remaining internal signals
  assign paddr__h1516 = { 32'd0, slave_xactor_f_wr_addr$D_OUT[60:29] } ;
  assign slave_xactor_f_wr_data_i_notEmpty_AND_master_x_ETC___d8 =
	     slave_xactor_f_wr_data$EMPTY_N &&
	     master_xactor_f_wr_addr$FULL_N &&
	     master_xactor_f_wr_data$FULL_N &&
	     f_trace_data$FULL_N ;
  assign x__h1682 = { 30'd0, sz__h1528 } ;
  assign x__h1710 = x__h1727 & y__h1728 ;
  assign x__h1727 =
	     slave_xactor_f_wr_data$D_OUT[36:5] >>
	     CASE_slave_xactor_f_wr_dataD_OUT_BITS_4_TO_1__ETC__q1 ;
  always@(slave_xactor_f_wr_data$D_OUT)
  begin
    case (slave_xactor_f_wr_data$D_OUT[4:1])
      4'h3, 4'hC: sz__h1528 = 2'b01;
      4'hF: sz__h1528 = 2'b10;
      default: sz__h1528 = 2'b0;
    endcase
  end
  always@(slave_xactor_f_wr_data$D_OUT)
  begin
    case (slave_xactor_f_wr_data$D_OUT[4:1])
      4'h2: CASE_slave_xactor_f_wr_dataD_OUT_BITS_4_TO_1__ETC__q1 = 32'd8;
      4'h3, 4'hF:
	  CASE_slave_xactor_f_wr_dataD_OUT_BITS_4_TO_1__ETC__q1 = 32'd0;
      4'h4, 4'hC:
	  CASE_slave_xactor_f_wr_dataD_OUT_BITS_4_TO_1__ETC__q1 = 32'd16;
      4'h8: CASE_slave_xactor_f_wr_dataD_OUT_BITS_4_TO_1__ETC__q1 = 32'd24;
      default: CASE_slave_xactor_f_wr_dataD_OUT_BITS_4_TO_1__ETC__q1 = 32'd0;
    endcase
  end
  always@(slave_xactor_f_wr_data$D_OUT)
  begin
    case (slave_xactor_f_wr_data$D_OUT[4:1])
      4'h1, 4'h2, 4'h4, 4'h8: y__h1728 = 32'h000000FF;
      4'h3, 4'hC: y__h1728 = 32'h0000FFFF;
      4'hF: y__h1728 = 32'hFFFFFFFF;
      default: y__h1728 = 32'd0;
    endcase
  end
